...
export const HERO_CONTENT = `I am a passionate Frontend developer with a knick for crafting robust and scalable web applications. With 2 years of hands-on experience, I have honed my skills in front-end technologies like React and Next.js, as well as technologies like Javascript, Typescript, Redux, TailwindCSS, Bootstrap. My goal is to leverage my expertise to create innovative solutions that drive business growth and deliver exceptional user experiences.`;
